...
public class Hiwan8UITest {
    ...
    private String confYamlFile = "src/test/Resources/config/androidconfig.yaml";
    ...
    @Test(description = "密码登录")
    public void Signin() throws InterruptedException {
        Thread.sleep(10000);
        driver.findElementById("com.wesai.hiwan:id/mine_text").click();//点击【我的】
        Thread.sleep(5000);
        int width = driver.manage().window().getSize().width;
        int height = driver.manage().window().getSize().height;
        driver.swipe(width * 3 / 4 , height / 2, width / 10,height / 2,3000);
        Thread.sleep(3000);//滑动到密码登录
        ...
        Assert.assertEquals("鹿旅途",driver.findElementById("com.wesai.hiwan:id/nickName").getText());


    }

//    @Test(description = "手机号密码用户登录")
//    public void LoginTest() throws InterruptedException, NoSuchLocatorException {
//       Thread.sleep(10000);
////       Action.click(page.getElement("myButton"));
//       driver.findElementById("com.wesai.hiwan:id/mine_text").click();
//       driver.findElementById("com.wesai.hiwan:id/edit_phone_number").sendKeys("15882066239");
//       driver.findElementById("com.wesai.hiwan:id/edit_pass_word").sendKeys("lucky20180101");
//       driver.findElementById("com.wesai.hiwan:id/btn_login").click();
...
//                "resource-id='com.wesai.hiwan:id/mine_text_tips'][1]").getText(),"863张");
...
//
//    @Test(description = "注册")
//    public void Signup() throws SQLException, ClassNotFoundException, InterruptedException {
//        driver.findElementById("com.wesai.hiwan:id/titlebar_tv_right").click();
//        driver.findElementById("com.wesai.hiwan:id/edit_phone_number").sendKeys("15882066239");
//        driver.findElementById("com.wesai.hiwan:id/tv_get_ver").click();
//        String ver_code = dbTest.sqlquery();
